...
std::string CConnmanConnection::GetUUID() const
{
  return m_name;
}
...
void CConnmanConnection::GetMacAddressRaw(char rawMac[6]) const
{
  // FIX Later;
}

std::string CConnmanConnection::GetInterfaceName() const
{
  // FIX Later;
  return m_name;
}
