...
class CNullNetworkManager : public INetworkManager, public IPassphraseStorage
{
  ...
  virtual bool HasStoredPassphrase(const std::string &uuid, IConnection *connection = NULL);
