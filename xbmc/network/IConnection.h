...
public:
  ...
  /*!
   \brief Get a unique identifier for the connection

   \return The connection's UUID
   \sa IConnection
   */
  ...
  /*!
   \brief Get the raw mac address of the connection

   \param rawMac The raw mac address of the connection
   \sa IConnection
   */
  virtual void GetMacAddressRaw(char rawMac[6]) const = 0;

  /*!
   \brief Get the name of the hardware interface

   \return The name of the hardware interface
   \sa IConnection
   */
